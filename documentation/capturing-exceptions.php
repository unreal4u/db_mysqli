...
} catch (unreal4u\exceptions\database $e) {
    exit($e->getMessage());
}


try {
    $insertId = $db->insertId('INSERT INTO a (string_valued, int_valued, bool_valued, string_null_valued, int_null_valued, bool_null_valued, float_valued, float_null_valued, datetime_valued,       datetime_null_valued, timestamp_valued, timestamp_null_valued) VALUES (?,?,?,?,?,?,?,?,?,?,NOW(),?)',
...
} catch (unreal4u\exceptions\query $e) {
